...
<body>
    ...
    <table border="1">
        <tr>
            ...
            <th>Número Total de Participantes</th>
            <th>Integrantes</th>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            // Exibe até 6 matrículas
            $integrantes = [];
            for ($i = 1; $i <= 6; $i++) {
                if (!empty($row["matricula_integrante_$i"])) {
                    $integrantes[] = $row["matricula_integrante_$i"];
                }
            }
            echo "<td>" . implode(", ", $integrantes) . "</td>"; // Exibe as matrículas separadas por vírgula
